...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{|p{5.0cm}|X|l|l|l|l|}
		...
		\textbf{TIPO DE INMUEBLE:} & \multicolumn{5}{l|}{%TIPO_INMUEBLE%} \\ \hline
		\textbf{DIRECCIÓN:} & \multicolumn{5}{l|}{%DIRECCION%} \\ \hline
		\textbf{COORDENADAS:} & \textbf{LATITUD:} & %LATITUD% & \textbf{LONGITUD:} & \multicolumn{2}{l|}{%LONGITUD%} \\ \hline
		\textbf{VEREDA} & \multicolumn{5}{l|}{%BARRIO%} \\ \hline
		\textbf{MUNICIPIO:} & %MUNICIPIO% & & \textbf{DEPARTAMENTO:} & \multicolumn{2}{l|}{%DEPARTAMENTO%} \\ \hline
		
		\multicolumn{6}{|c|}{\cellcolor{headergray}\textbf{2. INFORMACIÓN SOBRE TITULACIÓN}} \\ \hline
		\textbf{PROPIETARIO:} & \multicolumn{5}{l|}{%PROPIETARIO%} \\ \hline
		\textbf{TITULO DE ADQUISICIÓN:} & \multicolumn{5}{l|}{%DOC_PROPIEDAD%} \\ \hline
		\textbf{CÉDULA CATASTRAL:} & \multicolumn{5}{l|}{%CEDULA_CATASTRAL%} \\ \hline
		\textbf{NUPRE:} & \multicolumn{5}{l|}{%NUMPRE%} \\ \hline
		% Aquí la etiqueta ya no se cortará
		\textbf{MATRÍCULA INMOBILIARIA:} & \multicolumn{5}{l|}{%MATRICULA%} \\ \hline
		\textbf{OBSERVACIONES JURÍDICAS:} & \multicolumn{5}{p{13.0cm}|}{%LIMITACIONES%} \\ \hline
		...
		\textbf{NORMATIVIDAD} & \multicolumn{5}{p{13cm}|}{%USOS%} \\ \hline
	...
	\begin{tabularx}{\textwidth}{|X|X|}
		...
		\centering \includegraphics[width=0.9\linewidth]{%PATH_IMAGEN_AFECTADO%} & \includegraphics[width=0.9\linewidth]{%PATH_IMAGEN_USOS%}\\ \hline
		\centering Area afectada por el proyecto & \centering Uso segun EOT 
